...
% Lassen:1979tk, Tracer kinetic methods in medical physiology
...
The resolution process aims at estimating the system's impulse-response function, which is theoretically independant on the input, and because no assumption is made on the structure of the system, no assumption is made on the shape of the impulse-response function.
Parameters describing the systemic response of the vascular system are then derived from the estimated impulse-response function.
