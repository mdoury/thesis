...
\citet{Eastwood:2002hx} used a commercial perfusion quantification software, known as \emph{CT~Perfusion} (GE Medical Systems), to quantify brain perfusion in patients with acute stroke.
...
The software is basically a computational improvement of the method proposed by \citet{Cenic:1999un}, allowing processing of pixel-by-pixel parametric maps in less than five minutes, which makes it usable in clinical routine. 
...
% Wintermark:2005ua, Accuracy of dynamic perfusion CT with deconvolution in detecting acute hemispheric stroke.
...
% Impossible to perform deconvolution without assuming a known shape for the impulse response.
