...
Even before Stewart and Hamilton, hemodynamics of the heart had been studied  through indirect measurements and reported in German language by Volkmann~\cite{Volkmann:1850us} and Vierordt~\cite{Vierordt:82xUDMVI} in the 1850s, and later through direct measurements by Stolnikow~\cite{Stolnikow:1886wm} and Tigerstedt~\cite{Tigerstedt:1891wn}.
...
Derived from the work of Peters et al., semi-quantitative parameters were also proposed by Miles et al.~in 1991 to quantify renal cortical and medullary perfusion in X-ray computed tomography with bolus injection of Iodine~\cite{Miles:1991et,Miles:1991ei}. 
...
They emphasis the questionability of using grey-levels from ultrasond images to characterize blood flow, and instead recommend using attenuation based on transmission techniques, or backscattering after proper correction of signal attenuation.
...
Semi-quantitative parameters were evaluated in five regions of interest of the established unilateral view, i.e.~with an imaging depth of 100 mm, and nine regions of interest using a novel the bilateral view including both hemishperes, i.e.~with an imaging depth of 150 mm, of fourteen healthy patients. 
...
% IGR custom model
In 2006, members of the \em{Institut Gustave Roussy}, also known as IGR, filed a patent application for quantification approach developped specifically for contrast-enhanced ultrasound~\cite{Elie2014}.
...
% Mischi2003, Videodensitometric Methods for Cardiac Output Measurements
% Local Density Random Walk (LDRW) gives a physical interpretation of the dilution process, authors proposed the application of this diffusion with drift model to estimate the area under the curve and the mean transit time, which are then used to obtain tissue blood flow and tissue blood volume using indicator-dilution theory


% Mischi2008, On the physical and stochastic representation of an indicator dilution curve as a gamma variate
