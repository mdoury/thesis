...
Many of these studies used preliminary ultrasound contrast agents, yielding inconsistencies of the ultrasound signal and threrefore of the quantification process. 
...
% Meltzer:1980ul, Why do the lungs clear ultrasonic contrast?
...
% Carroll:1980vp, Gelatin encapsulated nitrogen microbubbles as ultrasonic contrast agents.

Additionally, early contrast-enhanced imaging techniques were not contrast specific, and often acquired using a high mechanical index causing the disruption of a large number of microbubbles.
Image interpretation was difficult as the background interfered with the enhancement caused by microbubbles, and the strength of the echo from the tissue is far too strong to detect microbubbles in the capillaries~\cite{Lencioni:2001cz}.
% Lencioni:2001cz, Tissue harmonic and contrast-specific imaging: back to gray scale in ultrasound
The simplest method to image bubbles in the microvasculature is through disruption, which can be achieved by sending high mechanical index ultrasound pulses, yielding a transient strong echo signal~\cite{Wray:1992wa,Porter:1995vs}.
% Wray:1992wa, Contrast echocardiography: relation of acoustic power and time gain compensation to contrast intensity duration
% Porter:1995vs, Transient myocardial contrast after initial exposure to diagnostic ultrasound pressures with minute doses of intravenously injected microbubbles. Demonstration and potential mechanisms.
Because the high mechanical index pulse destroys a large portion of microbubbles in the imaging plane, if the following pulse is too close in time their will only be a small number of microbubbles to be disrupted and the echo signal intensity will be considerably lower.
This is the reason why intermittent imaging, also known as transient imaging, was proposed by \citet{Porter:1995vs}. 
Indeed, acquiring ultrasound images with a higher pulsing interval allows microbubbles to refill the imaging plane, consequently destroying more bubbles with each pulse and yielding a stronger backscattered intensity~\cite{Porter:1995vs,Wei:1997fd}.
% Porter:1995vs, Transient myocardial contrast after initial exposure to diagnostic ultrasound pressures with minute doses of intravenously injected microbubbles. Demonstration and potential mechanisms.
% Wei:1997fd, Interactions between microbubbles and ultrasound: in vitro and in vivo observations.
Contrast-enhanced Doppler imaging was also proposed, but while the improved sensitivity allowed quantitative imaging of blood flow even in small and deep vessels, it still failed to image the microvasculature, especially in moving tissues~\cite{deJong:2000fg,Leen:2001}.
% deJong:2000fg, Detection procedures of ultrasound contrast agents
% Leen:2001, Ultrasound contrast harmonic imaging of abdominal organs
Real-time non-destructive contrast-specific ultrasound imaging only arose with the development of pulse inversion sequences using low mechanical index in the late 1990s~\cite{Simpson:1997jn,Tiemann:1999vy}.
% Simpson:1997jn, Pulse inversion Doppler: a new method for detecting nonlinear echoes from microbubble contrast agents
% Tiemann:1999vy, Are microbubbles free flowing tracers through the Myocardium? Comparison of indicator-dilution curves obtained from dye dilution and echo contrast using harmonic power Doppler imaging.
