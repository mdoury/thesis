...
In \citeyear{Knopp:1976uc}, a deconvolution method insensitive to noise, recirculation, and impulse response shape was proposed by \citet{Knopp:1976uc} to assess the impulse response of the coronary bed.
...
% Gamel:1973, Pitfalls in digital computation of the impulse response of vascular beds from indicator-dilution curves


\subsection{Nuclear medicine}
% Kenny:1975gl, Deconvolution analysis of the scintillation camera renogram.
Following the development of \citet{Short:1973ip} in the field of renography based on gamma-camera acquisitions, \citet{Kenny:1975gl} proposed a deconvolution technique in an attempt to make the estimation of the kidney function independent on the spread of the bolus when it enters the kidney, and assessed it in a clinical study.
