...
Then Section~\ref{sec:DeconvolutionMethods} presents deconvolution-based quantification methods, estimating the vascular impulse response in the tissue of interest by means of blind or regularized deconvolution.
