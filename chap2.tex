...
In another section addressing the impact of recirculation, he established the relation between convolution integrals and Laplace transforms.
...
\subsection{Nuclear medicine}
% Flemming:1974, A technique for the deconvolution of the renogram
%%% TO FIND, AND TO DO

% Kenny:1975gl, Deconvolution analysis of the scintillation camera renogram.
Following the development of renography based on gamma-camera acquisitions by \citet{Short:1973ip}, \citet{Kenny:1975gl} proposed a deconvolution technique, based on the Laplace transform, in an attempt to make the estimation of the kidney function independent on the spread of the bolus when it enters the kidney, and assessed it in a clinical study.
