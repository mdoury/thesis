...
The software is basically an improvement of the method proposed by \citet{Cenic:1999un}, allowing processing of pixel-by-pixel parametric maps in less than five minutes with improved stability, by means of singular value decomposition, which makes it usable in clinical routine.
In this technique, noise filtering is enforce by thresholding of the singular values.
