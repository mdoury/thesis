...
% Coulam:1966, A transfer function analysis of coronary and renal circulation calculated from upstream and downstream indicator-dilution curves
% Maseri:1970, Frequency function of transit times through dog pulmonary circulation
% Neufeld:1971, Computation of transit time distribution using sampled data Laplace transforms
% Knopp:1976, Transcoronary intravascular transport functions obtained via a stable deconvolution technique
% Alderson:1979, Deconvolution analysis in radionucleide quantitation of left-to-right cardiac shunts
