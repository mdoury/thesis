...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{DelayEstimation.eps}
...
In Figures~\ref{fig:noise_rV} to \ref{fig:sampling_D}, each plot represents a tumor region, i.e.~the top row corresponds to the outer rim and the bottom row to the inner rim, the columns correspond to the clockwise ordering of the regions on a rim starting with the left region above the horizontal line.
...
\begin{subfigures}
    ...
    \end{figure}
    \begin{figure}\centering
        \includegraphics[width=0.95\linewidth]{simNoise_D.eps}
...
\begin{subfigures}
    ...
    \end{figure}
    \begin{figure}\centering
        \includegraphics[width=0.95\linewidth]{simSamples_D.eps}
...
\begin{subfigures}
    ...
    \end{figure}
    \begin{figure}
        \includegraphics[width=\linewidth]{simSampling_D.eps}
