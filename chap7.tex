...
\caption{Median (large symbols) and first and third quartiles (small symbols) of the relative estimation error, expressed as a percentage of the ground truth value, for the relative blood volume ($rV$) estimated using the \textbf{rLin} model (yellow diamonds) and \textbf{rReg} models (purple squares), as a function of the exam duration, in seconds.}
\label{fig:examDuration_rV}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{simSamples_rF.eps}
\caption{Median (large symbols) and first and third quartiles (small symbols) of the relative estimation error, expressed as a percentage of the ground truth value, for the relative blood flow ($rF$) estimated using the \textbf{rLin} model (yellow diamonds) and \textbf{rReg} models (purple squares), as a function of the exam duration, in seconds.}
\label{fig:examDuration_rF}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{simSamples_kT.eps}
\caption{Median (large symbols) and first and third quartiles (small symbols) of the relative estimation error, expressed as a percentage of the ground truth value, for the rate constant in the tumor ($k_T$) estimated using the \textbf{rLin} model (yellow diamonds) and \textbf{rReg} models (purple squares), as a function of the exam duration, in seconds.}
\label{fig:examDuration_kT}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{simSamples_kR.eps}
\caption{Median (large symbols) and first and third quartiles (small symbols) of the relative estimation error, expressed as a percentage of the ground truth value, for the rate constant in the reference tissue ($k_R$) estimated using the \textbf{rLin} model (yellow diamonds) and \textbf{rReg} models (purple squares), as a function of the exam duration, in seconds.}
\label{fig:examDuration_kR}
\end{figure}


\paragraph{Sampling period}
Similarly, Figure~\ref{fig:samplingPeriod} shows the impact of the sampling period on the relative estimation error of the (a)~relative tissue blood volume, (b)~relative tissue blood flow, and (c)~rate constants in the tumor and reference tissues for the \textbf{rLin} and \textbf{rReg} models.

% \begin{figure}
% \includegraphics[width=\linewidth]{Fig3.eps}
% \caption{}
% \label{fig:samplingPeriod}
% \end{figure}
...
The impact of varying the number of regions on the accuracy and precision of the estimates of the \textbf{rLin} and \textbf{rReg} models is shown in Figure~\ref{fig:regionNumber}.

% \begin{figure}
% \includegraphics[width=\linewidth]{Fig5.eps}
% \caption{}
% \label{fig:regionNumber}
% \end{figure}
