...
\caption{Relative perfusion parameters used for simulation varying the number of regions from 1 (left) to 32 (right), i.e.~relative tissue blood volume, $rV$, relative tissue blood flow, $rF$, tissue rate constant, $k_T$.}
\label{fig:simReg}
\end{figure}
...
In Figures~\ref{fig:examDuration_rV}-\ref{fig:examDuration_kR}, each plot represents a tumor region, i.e.~the top row corresponds to the outer rim and the bottom row to the inner rim, the columns correspond to the clockwise ordering of the regions on a rim starting with the left region above the horizontal line.
...
\paragraph{Reference tissue}
The effect of varying the characteristics of the reference tissue on the accuracy and precision of the estimation process are displayed in Figure~\ref{fig:referenceTissue}. 

% \begin{figure}
% \includegraphics[width=\linewidth]{Fig4.eps}
% \caption{}
% \label{fig:referenceTissue}
% \end{figure}
