...
Additionally, the \textbf{rReg} model makes the estimation bias of $rV$ more consistant across regions.
...
Indeed, the \textbf{rReg} model exhibited an extremely consistant estimation bias across regions, with an average of -3\%, and a lower sensitivity to noise.
...
The relative tissue blood volume, $rV$, estimated using the \textbf{rLin} model (see Figure~\ref{fig:referenceTissue_rV_rLin}) revealed sensitive to variations of parameter $k_R$.
...
Using the \textbf{rReg} model (see Figure~\ref{fig:referenceTissue_rV_rReg}) reduced the discrepencies across regions compared to the \textbf{rLin} model, but varying $k_R$ one way or the other overestimated the values of $rV$.
Similarly, the relative blood flow, $rF$, estimated using either the \textbf{rLin} model (see Figure~\ref{fig:referenceTissue_rF_rLin}) or the \textbf{rReg} model (see Figure~\ref{fig:referenceTissue_rF_rReg}) were sensitive to variations of $k_R$. 
...
Regarding the rate constant in the tumor, $k_T$, large discrepencies can be observed using the \textbf{rLin} model (see Figure~\ref{fig:referenceTissue_kT_rLin}), and they tend to increase with decreasing values of $k_R$.
Using the \textbf{rReg} model (see Figure~\ref{fig:referenceTissue_kT_rReg}), the bias in the estimation of $k_T$ increased for lower values of $k_R$.
...
The rate constant in the reference tissue, $k_R$, exhibited behaviors extremely similar to those of $k_T$, whether estimated using the \textbf{rLin} model (see Figure~\ref{fig:referenceTissue_kR_rLin}) or the \textbf{rReg} model (see Figure~\ref{fig:referenceTissue_kR_rReg}).
